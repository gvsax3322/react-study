...
- 우선 각 내용영역 html (컴포넌트) 을 배치해서 화면(page) 를 모아둔 pages 폴더가 있으면 좋겠습니다.
- 각 내용 영역 html(컴포넌트) 을 모아둘 src/components 폴더가 있으면 좋겠습니다.
- src/pages 폴더 생성
...
-컴포넌트를 구성하는 작업을 진행함 -상단영역 컴포넌트 생성 (src/components/Header.js)
